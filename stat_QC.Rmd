...
###XmR Default Overlay###
```{r Default XmR, fig.width=4, fig.height=4}
INDV + stat_QC(method="XmR")
```

###Change Center-Line Color###
```{r Center Line Color, fig.width=4, fig.height=4}
INDV + stat_QC(method="XmR", color.qc_center = "blue")
```

###Change Limit-Line Color###
```{r Limit Line Color, fig.width=4, fig.height=4}
INDV + stat_QC(method="XmR", color.qc_limits = "black", size=1)
```
